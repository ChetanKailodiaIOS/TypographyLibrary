...
extension NSMutableAttributedString {
    ...
    var italicFont:UIFont { return .italicSystemFont(ofSize: fontSize - 2) }
    var bodyFont:UIFont { return UIFont(name: "Roboto-Regular", size: fontSize) ?? UIFont.systemFont(ofSize: fontSize) }
    
   public func bodyText(_ value: String) -> NSMutableAttributedString {
    ...
    public func bodyItalicText(_ value: String) -> NSMutableAttributedString {
        let attributes:[NSAttributedString.Key : Any] = [
            .font : italicFont
        ]
        self.append(NSAttributedString(string: value, attributes:attributes))
